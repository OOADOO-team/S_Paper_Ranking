...
p1 = Paper(title="paper1", authors='Wentao1', public_in='Sustech1', data='aaaaaaaa', url='localhost:5000',
           ...
           citations=[Paper(), Paper(), Paper()], references=[Paper(), Paper()])
p2 = Paper(title="paper2", authors='Wentao2', public_in='Sustech2', data='aaaaaaaa', url='localhost:5000',
           abstract='this is the abstract of paper 2. this is the abstract of paper 2. this is the abstract of paper '
                    '2. this is the abstract of paper 2. this is the abstract of paper 2. this is the abstract of '
                    'paper 2. this is the abstract of paper 2. this is the abstract of paper 2.',
           citations=[Paper(), Paper(), Paper(), Paper()], references=[Paper(), Paper()])
...
p4 = Paper(title="paper4", authors='Wentao4', public_in='Sustech4', data='aaaaaaaa', url='localhost:5000',
           abstract='this is the abstract of paper 4. this is the abstract of paper 4. this is the abstract of paper '
                    '4. this is the abstract of paper 4. this is the abstract of paper 4. this is the abstract of '
                    'paper 4. this is the abstract of paper 4. this is the abstract of paper 4.',
           citations=[Paper(), Paper(), Paper(), Paper()], references=[Paper(), Paper()])
